...
wk.add(
  {
    ...
    { "<leader>ld", ":! kitten @ launch --type overlay --cwd current lazydocker<CR>", desc = "Docker" },
    { "<leader>lg", ":! kitten @ launch --type overlay --cwd current lazygit<CR>", desc = "Git" },
    { "<leader>lj", ":! kitten @ launch --type overlay --cwd current lazyjj<CR>", desc = "Jujutsu" },
