...
wk.add(
  {
    ...
    { "<leader>ct", ":Trouble diagnostics toggle<CR>", desc = "Show diagnostics"},
    ...
    { "<leader>ed", ":Yazi cwd<CR>", desc = "Explore at current directory" },
    { "<leader>ef", ":Yazi<CR>", desc = "Explore at current file" },
    { "<leader>et", ":Yazi toggle<CR>", desc = "Explore at last session" },
